...
import { Sparkles, X, Send, Loader2, Bot, ExternalLink, Building2, FileText, Receipt, FileInput, FileDown, ClipboardList, Truck, User } from 'lucide-react'
import { Link } from 'react-router-dom'
import { cn, formatEuro } from '@/lib/utils'
import { useAiChat, type ChartData, type EntityRef } from '@/features/ai-agent/useAiChat'
